...
public class CCWTemplate : ICLR
{

}

public class SparseVTableEntry : ICLR
{

}

public class SparseVTableMap : ICLR
{

}

public class LayoutInfo : ICLR
{
    [Flags]
...
public class NativeLayoutInfo : ICLR
{

}

public class NativeFieldDescriptor : ICLR
{

}

public class OptionalFields : ICLR
{

}

public class EEClass : ICLR
{
    [Flags]
